        ...
        <div class="row justify-content-center align-items-center" style="min-height: 100vh">
            <div class="col-12 text-center" style="margin-top: -50px">
                <div class="m-auto" style="width: 75%">
                    <svg id="06c42c9d-6d9c-45ee-a61b-17902c1dca73" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%"
                        height="300px" viewBox="0 0 1145.57 819.91">
                        <defs>
                            <linearGradient id="2f697947-2a6f-450c-95af-56e5336b1d5f" x1="591.3" y1="646.08" x2="591.3"
                                y2="107.75" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                            </linearGradient>
                            <linearGradient id="2563b911-9cd4-457d-b636-acc38b40f33a" x1="944.34" y1="854.67"
                                x2="944.34" y2="289.29" xlink:href="#2f697947-2a6f-450c-95af-56e5336b1d5f" />
                        </defs>
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="{{ $color }}" opacity="0.1" />
                        <ellipse cx="120.3" cy="728.81" rx="88.28" ry="14.18" fill="{{ $color }}" opacity="0.1" />
                        <ellipse cx="912.26" cy="804.71" rx="156.53" ry="15.2" fill="{{ $color }}" opacity="0.1" />
                        <rect x="116.14" y="107.75" width="950.33" height="538.33" rx="12.49" ry="12.49"
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="#5a5773" />
                        ...
                        <rect x="195.68" y="181.67" width="254.25" height="21.58" fill="{{ $color }}" opacity="0.2" />
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="{{ $color }}" />
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="url(#2563b911-9cd4-457d-b636-acc38b40f33a)" />
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="#c37098" />
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="#3f3d56" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="none" />
                        <path
                            d="M897.1,833.86s-4.28,5.32-10,5.73a5.89,5.89,0,0,0-5.84,5.63s1,3.24-12.83,7.73c-8.35,2.69-13.6,1.84-16.66,0,7.87-.82,25.26-5.79,27-7.51,2.09-2.09,4.7-7.83,6.47-7.93,1.23-.08,7.48-3.84,11.23-6.17Z"
                            transform="translate(-26.97 -40.04)" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" opacity="0.1" />
                        <path d="M976,341.77a29.3,29.3,0,1,1-29.3-29.3A29.16,29.16,0,0,1,976,341.77Z"
                            transform="translate(-26.97 -40.04)" fill="#c37098" />
                        <polygon
                        ...
                        <path
                            d="M939.23,396.3l18.78.63-5.28,7.39s.37,14.93,2.88,19.21,1.77,70.4,1.77,70.4l-5,9.49-8.55-10.64.11-87.3Z"
                            transform="translate(-26.97 -40.04)" opacity="0.1" />
                        <polygon points="941.67 336.86 924.15 356.26 934.16 366.69 950.75 350.52 941.67 336.86"
                            opacity="0.1" />
                        <polygon points="941.67 335.61 924.15 355.01 934.16 365.44 950.75 349.27 941.67 335.61"
                            fill="{{ $color }}" />
                        <polygon points="916.75 355.32 899.01 337.59 897.34 346.87 905.48 367.21 916.75 355.32"
                            opacity="0.1" />
                        <polygon points="917.37 354.07 899.64 336.34 897.97 345.62 906.11 365.96 917.37 354.07"
                            fill="{{ $color }}" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" opacity="0.1" />
                        <path d="M1004.63,524l.44,16.75-4.82,4.37L997,504.57h7.2Z" transform="translate(-26.97 -40.04)"
                            opacity="0.1" />
                        <path
                        ...
                        <path d="M992.47,804.34s18.84,1.46,20.71,2.92S992.47,804.34,992.47,804.34Z"
                            transform="translate(-26.97 -40.04)" stroke="{{ $color }}" stroke-miterlimit="10"
                            opacity="0.1" />
                        <path d="M880.3,789.53s4,5,2.3,7.3S880.3,789.53,880.3,789.53Z"
                            transform="translate(-26.97 -40.04)" stroke="{{ $color }}" stroke-miterlimit="10"
                            opacity="0.1" />
                        <path d="M885.1,807.56s7.3-4.8,10.22-1.61S885.1,807.56,885.1,807.56Z"
                            transform="translate(-26.97 -40.04)" stroke="{{ $color }}" stroke-miterlimit="10"
                            opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="{{ $color }}" />
                        <polygon points="910.5 290.85 910.5 291.33 927.83 291.33 927.83 290.76 910.5 290.85"
                            fill="{{ $color }}" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="#3f3d56" />
                        <polygon points="158.48 590.46 157.98 598.59 82.61 598.59 82.11 590.46 158.48 590.46"
                            fill="#9d9cb5" />
                        <polygon points="157.77 601.98 157.27 610.12 83.33 610.12 82.82 601.98 157.77 601.98"
                            fill="#9d9cb5" />
                        <polygon points="157.05 613.51 156.55 621.64 84.05 621.64 83.54 613.51 157.05 613.51"
                            fill="#9d9cb5" />
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="{{ $color }}" />
                        <path d="M27.46,519.87s41.38,23,54.65,42,65.16,44.68,65.16,44.68"
                            transform="translate(-26.97 -40.04)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            d="M121.76,497c18,13,25.51,33.4,25.51,33.4s-21.7-.74-39.71-13.77-25.5-33.4-25.5-33.4S103.76,483.92,121.76,497Z"
                            transform="translate(-26.97 -40.04)" fill="{{ $color }}" />
                        <path d="M82.06,483.18s22.52,12.5,29.74,22.85,35.47,24.32,35.47,24.32"
                            transform="translate(-26.97 -40.04)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            ...
                            transform="translate(-26.97 -40.04)" fill="{{ $color }}" />
                        <path d="M223.28,499.43s-26.94,23.3-33.79,39.36-41.11,43-41.11,43"
                            transform="translate(-26.97 -40.04)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                    </svg>
                </div>
                <div style="font-family: 'Nunito', sans-serif; font-size:30px; color:#2f2e41">Unauthorized</div>
                <p style="color: #687281;">Anda Tidak Memiliki Akses</p>
