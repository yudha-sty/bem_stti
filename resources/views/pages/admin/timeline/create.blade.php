...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Jadwal Kegiatan</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="date" class="form-control" name="activity_date_start" value="{{ old('activity_date_start') }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="date" class="form-control" name="activity_date_end" value="{{ old('activity_date_end') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="time" class="form-control" name="activity_time_start" value="{{ old('activity_time_start') }}">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="time" class="form-control" name="activity_time_end" value="{{ old('activity_time_end') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
